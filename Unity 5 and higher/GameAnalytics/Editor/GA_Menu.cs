...
namespace GameAnalyticsSDK.Editor
{
    public static class GA_Menu
    {
        ...
        static void AddGASystemTracker ()
        {
            ...
            {
                GameObject go = PrefabUtility.InstantiatePrefab(AssetDatabase.LoadAssetAtPath("Packages/com.triflesgames.gameanalytics/Plugins/Prefabs/GameAnalytics.prefab", typeof(GameObject))) as GameObject;
